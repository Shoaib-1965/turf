...
import 'package:turf_app/features/activity/presentation/widgets/activity_type_picker.dart'
    as turf_picker;
...
class FloatingBottomStats extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final String distance =
        '${profileAsync.value?.totalDistanceKm.toStringAsFixed(1) ?? "0.0"} km';
    final String territoriesCount =
        territoriesAsync.value
                  ...
                  GestureDetector(
                    onTap: () {
                      showModalBottomSheet(
                        ...
                        builder: (context) =>
                            const turf_picker.ActivityTypePicker(),
                      );
                    },
                    child: Container(
                      width: 48,
