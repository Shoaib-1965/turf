...
class CityGridPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final baseMinorPaint = Paint()
      ..color = const Color(0xFF142014).withValues(alpha: 0.6)
      ..strokeWidth = 0.8
      ..style = PaintingStyle.stroke;

    final baseMajorPaint = Paint()
      ..color = const Color(0xFF1A2A1A).withValues(alpha: 0.8)
      ..strokeWidth = 1.8
      ..style = PaintingStyle.stroke;
      ...
      if (currentRadius > 0) {
        ...
        final glowShader = RadialGradient(
          colors: [
            ...
            const Color(0xFF00FF41).withValues(alpha: 0.7), // neon spread
            const Color(0xFF00FF41).withValues(alpha: 0.0), // fade into darkness
          ],
