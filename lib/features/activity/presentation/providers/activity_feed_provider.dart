...
import 'package:turf_app/features/activity/data/feed_repository.dart';
...
class ActivityFeedNotifier extends Notifier<ActivityFeedState> {
  ...
  Future<void> loadMoreMyActivities() async {
    ...
    try {
      ...
      print('Error loading more my activities: $e');
    }
  }
  ...
  Future<void> loadMoreFriendsActivities() async {
    ...
    try {
      ...
      print('Error loading more friends activities: $e');
    }
  }
