...
class FeedCard extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return GestureDetector(
      onTap: () =>
          context.push('/activity/${activity.session.id}', extra: activity),
      child: Container(
        decoration: BoxDecoration(
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          timeago.format(activity.session.endedAt),
                          style: const TextStyle(
                  ...
                  Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        color: _getTypeColor(activity.session.activityType),
                        fontSize: 10,
                        fontWeight: FontWeight.bold,
                      ),
                    ),
            ...
            Padding(
              ...
              child: Row(
                children: [
                  _StatText(
                    icon: Icons.timer,
                    text: _formatDuration(activity.session.durationSeconds),
                  ),
                  const SizedBox(width: 16),
                  _StatText(
                    icon: Icons.speed,
                    text:
                        '${activity.session.avgSpeedKmh.toStringAsFixed(1)} km/h',
                  ),
                  const SizedBox(width: 16),
                  _StatText(
                    icon: Icons.local_fire_department,
                    text: '${activity.session.caloriesBurned} kcal',
                  ),
                ],
              ),
            ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    ...
                    Text(
                      '${activity.territoriesCaptured} Territories Captured',
                      style: const TextStyle(
                        color: Color(0xFF00E676),
                        fontSize: 12,
                        fontWeight: FontWeight.bold,
              ...
              child: Row(
                children: [
                  _ActionButton(
                    ...
                    onTap: () => ref
                        .read(activityFeedProvider.notifier)
                        .toggleLike(activity.session.id!, true),
                  ),
