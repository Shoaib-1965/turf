  ...
  Future<void> _joinClub(Club club) async {
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Failed to join club.')));
    }
  }
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        margin: EdgeInsets.only(
          right: isDiscover ? 0 : 16,
          bottom: isDiscover ? 16 : 0,
        ),
        decoration: BoxDecoration(
          color: const Color(0xFF1C1C1E),
          borderRadius: BorderRadius.circular(16),
          border: isOwner && !isDiscover
              ? const Border(
                ...
                child: myClubsAsync.when(
                  ...
                  data: (clubs) {
                    if (clubs.isEmpty) {
                      return const Center(
                        child: Text(
                          'Create your first club or join one',
                          style: TextStyle(color: Colors.white54),
                        ),
                      );
                    }
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) =>
                          _buildClubCard(clubs[index], isDiscover: false),
                    );
                  },
                ),
              ),
              ...
              data: (clubs) {
                ...
                return SliverPadding(
                  ...
                  sliver: SliverList(
                    delegate: SliverChildBuilderDelegate(
                      (context, index) =>
                          _buildClubCard(clubs[index], isDiscover: true),
