  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: leaderboardAsync.when(
        ...
        data: (participants) {
          final myParticipantIndex = participants.indexWhere(
            (p) => p.userId == currentUserId,
          );
          final myParticipant = myParticipantIndex != -1
              ? participants[myParticipantIndex]
              : null;
                      ...
                      Row(
                        ...
                        children: [
                          _InfoPill(
                            icon: Icons.flag,
                            text:
                                '${challenge.targetValue.toInt()} ${_getUnit(challenge.challengeType)}',
                          ),
                          _InfoPill(
                            icon: Icons.group,
                            text: '${participants.length} joined',
                          ),
                          _InfoPill(
                            icon: Icons.star,
                      ...
                      child: Row(
                        children: [
                          ...
                          CircleAvatar(
                            ...
                            backgroundImage:
                                participant.profile?.avatarUrl != null
                                ? CachedNetworkImageProvider(
                                    participant.profile!.avatarUrl!,
                                  )
                                : null,
                            child: participant.profile?.avatarUrl == null
                                ? const Icon(
                                    Icons.person,
                                    color: Colors.white54,
                                    size: 16,
