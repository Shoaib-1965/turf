...
import 'package:turf_app/features/goals/presentation/providers/goal_provider.dart';
                ...
                children: [
                  ...
                  DropdownButtonFormField<String>(
                    ...
                    onChanged: (v) {
                      setState(() {
                        _goalType = v!;
                        if (_goalType.contains('weekly'))
                          _endDate = _startDate.add(const Duration(days: 7));
                        if (_goalType.contains('monthly'))
